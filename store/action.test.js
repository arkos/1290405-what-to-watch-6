import {changeGenre, loadMovies, ActionType, requireAuthorization, redirectToRoute, changeActiveTab, changeCountToRender, resetMain, changeDataProcessingState, reloadMovie, loadPromo, loadReviews, loadFavorites, saveReview, addFavorite, loadUser} from '../store/action';
import {AuthorizationStatus, TabName, MOVIES_PER_PAGE, State} from '../util/const';
